...
const LoginForm = () => {
  ...
  const handleGoogleLogin = () => {
    console.log('🔐 [LoginForm] Google login initiated - redirecting to OAuth flow')
    // Redirect to backend OAuth endpoint
    // Fallback to localhost:3000 if env vars are not set (for development)
    ...
    console.log('🔐 [LoginForm] Google login - Redirecting to:', authUrl);
    ...
    <div className="bg-white p-6 rounded-xl shadow-md w-80 mx-auto mt-20">
      ...
      <div className="mt-4 text-center">
        <button
          ...
          className="w-full bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 rounded-lg px-4 py-2 transition-colors flex items-center justify-center gap-3"
        >
